package com.leandroperez.taf.utils.jsonutil;
...
public class JsonUtil {
    ...
    public Map<String, String> getCustomSettings() {
        String profileName = getProfileFileName(getCustomProperties().get("dataSource1")); loadJsonConfig(profileName);
    ...
    public void loadJsonConfig(String profileName) {
        ...
        try {
            ...
            customSettings = gson.fromJson(reader, (Type)
                    Map.class);
        } catch (Exception e) {
